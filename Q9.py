...
#For e.g. if Chef bought 3 items with the cost 6, 2 and 4, then he would get the item with cost 
#2 as free. So he would only have to pay the cost of the other two items which will be 6+4=10
